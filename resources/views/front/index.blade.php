...
<section id="home-section" class="hero">
            ...
            <div class="slider-item js-fullheight">
                ...
                <div class="container-fluid p-0">
                    <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-end"
                        ...
                        <img class="one-third order-md-last img-fluid" src="{{ asset('images/slider/' . $item->image) }}"
                            alt="">
                        <div class="one-forth d-flex align-items-center ftco-animate"
                            ...
                            <div class="text">
                                ...
                                <div class="horizontal">
                                    ...
                                    <p><a href="{{ route('shop.ShowAllProducts') }}" class="btn-custom">Discover Now</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
    		...
    		<div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-3 ftco-animate d-flex">
    				<div class="product d-flex flex-column">
                        <a href="{{route('single_product',$product->id)}}" class="img-prod"><img class="img-fluid" style="width: 286px;height:300px" src="{{ asset('images/product/'.$product->image)}}"
    						...
    						<h3><a href="{{route('single_product',$product->id)}}">{{$product->name}}</a></h3>
  							<div class="pricing">
	    						<p class="price"><span class="mr-2 price-dc">${{$product->price}}</span>
                                    ...
                                    <span class="price-sale">${{$product->compare_price}}</span></p>
                                    @endif
	    					</div>
    ...
    <section class="ftco-section ftco-choose ftco-no-pb ftco-no-pt">
    	<div class="container">
				<div class="row no-gutters">
					<div class="col-lg-4">
						<div class="choose-wrap divider-one img p-5 d-flex align-items-end" style="background-image: url({{asset('cms/images/choose-1.jpg')}});">
    				...
    				<div class="row no-gutters choose-wrap divider-two align-items-stretch">
    					<div class="col-md-12">
	    					<div class="choose-wrap full-wrap img align-self-stretch d-flex align-item-center justify-content-end" style="background-image: url({{asset('cms/images/choose-2.jpg')}});">
    					...
    					<div class="col-md-12">
    						<div class="row no-gutters">
	    						...
	    						<div class="col-md-6">
		    						<div class="choose-wrap wrap img align-self-stretch d-flex align-items-center" style="background-image: url({{asset('cms/images/choose-3.jpg')}});">
    ...
    <section class="ftco-section ftco-deal bg-primary">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-6">
    				<img src="{{asset('cms/images/prod-1.png')}}" class="img-fluid" alt="">
    			</div>
    			<div class="col-md-6">
    				...
    				<div id="timer" class="d-flex mb-4">
						...
						<div class="text-deal">
							...
							<ul class="thumb-deal d-flex mt-4">
								<li class="img" style="background-image: url({{asset('cms/images/product-6.png')}});"></li>
								<li class="img" style="background-image: url({{asset('cms/images/product-2.png')}});"></li>
								<li class="img" style="background-image: url({{asset('cms/images/product-4.png')}});"></li>
							</ul>
						</div>
    			</div>
    		</div>
