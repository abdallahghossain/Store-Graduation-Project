    ...
    <div class="col-xl-12 ">
        ...
        <div class="card card-flush h-lg-100" id="kt_contacts_main">
            ...
            <div class="card-body pt-5">
                <!--begin::Form-->
                <form  action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_settings_general_form" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
                    <x-alert/>
                    <!--begin::Input group-->
                    <div class="mb-7">
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" name="url" id="url" value="">
                        <!--end::Input-->
                        <div class="fv-plugins-message-container invalid-feedback"></div></div>
                    <!--begin::Row-->
                    <div class="col">
