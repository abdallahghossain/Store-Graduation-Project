        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bold fs-3 mb-1">{{ __('Sliders List') }}</span>
                ...
                <div class="card-toolbar">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                        ...
                        <div class="menu-item px-3 menu-state-bg-light-success">
                            <a href="{{ route('slider.create') }}" class="menu-link px-3 bg-light-success"
                                style="color: green">{{ __('Create Product') }}</a>
                            <br>
                        </div>
                        <div class="menu-item px-3">
                            <a href="{{ route('slider.index') }}" class="menu-link px-3">{{ __('back') }}</a>
                            <br>
                        </div>
                    </div>
                    <!--end::Menu 2-->
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <tbody>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="symbol symbol-50px me-5">
                                                <span class="symbol-label bg-light">
                                                    <img src="{{ asset('images/slider/' . $data->image) }}" class="h-100 w-100"
                                                        alt="">
                                                </span>
                                            </div>
                            ...
                            @empty
                                <tr>
                                    <td class="text-danger fw-boldest text-center" colspan="6">
                                        {{ __('No Slider Found') }}</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
