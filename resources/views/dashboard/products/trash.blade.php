                        ...
                        <thead>
                            <span>
                                <a href="{{ route('products.index') }}"
                                    class="btn btn-outline-info btn-sm ml-4 mb-3">{{ __('back') }}</a>
                            </span>
                                ...
                                <tr>
                                    ...
                                    <td class=" d-flex gap-1">
                                        <form action="{{ route('products.restore', $product->id) }}" method="post">
                                            ...
                                            @method('put')
                                            <button type="submit"
                                                class="btn btn-outline-info btn-sm mt-2">{{ __('Restore') }}</button>
                                        ...
                                        <span>
                                            <form action="{{ route('products.force-delete', $product->id) }}"
                                                ...
                                                @method('delete')
                                                <button type="submit"
                                                    class="btn btn-outline-danger btn-sm mt-2">{{ __('Delete') }}</button>
