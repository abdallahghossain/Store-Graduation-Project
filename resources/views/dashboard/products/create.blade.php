                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <label class="fs-6 fw-semibold form-label mt-3">
                            <span class="required">{{ __('Product Name Arabic') }}</span>
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        {{-- <input type="number" class="form-control form-control-solid" name="category_id" value=""> --}}
                        <!--end::Input-->
                        <div class="fv-plugins-message-container invalid-feedback"></div>
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="col">
                        <div class="fv-row mb-7">
                            ...
                            <textarea name="description"class="form-control form-control-solid" id="" cols="30" rows="10"></textarea>
                        </div>
                    </div>
