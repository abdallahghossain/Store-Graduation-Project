                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="mt-1">
                            ...
                            <div class="image-input image-input-outline image-input-placeholder image-input-empty image-input-empty"
                                ...
                                <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                    ...
                                    {{-- <div> <img src="{{asset('storage/'.$product->image)}}" class="img-fluid" alt=""></div> --}}
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <label class="fs-6 fw-semibold form-label mt-3">
                            <span class="required">{{ __('Product Name Arbic') }}</span>
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" name="name[ar]" id="name"
                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        <!--begin::Label-->
                        <label class="fs-6 fw-semibold form-label mt-3">
                            <span class="required">{{ __('Product Name English') }}</span>
                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                aria-label="Enter the contact's name." data-bs-original-title="Enter the contact's name."
                                data-kt-initialized="1"></i>
                        </label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" class="form-control form-control-solid" name="name[en]" id="name"
                    ...
                    <div class="col">
                        <div class="fv-row mb-7">
                            ...
                            <textarea name="description"class="form-control form-control-solid" id="" cols="30" rows="10">{{ $product->description }}</textarea>
                        </div>
                    </div>
