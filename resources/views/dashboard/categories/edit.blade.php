                    ...
                    <div class="fv-row mb-7 fv-plugins-icon-container">
                        ...
                        <div class="col">
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="description"class="form-control form-control-solid" id="" cols="30" rows="10">{{ $category->description}}</textarea>
                            </div>
                        </div>
                        <div class="form-check form-check-custom form-check-solid form-check-primary">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="status" value="archived" @if($category->status == 'archived') checked    @endif>
                                <label class="form-check-label" for="status">
                                    {{__('archived')}}
                                </label>
                            </div>
